...
export const PATIENTS: Patient[] = [
  { id: 1,  room: "101A", name: "Dorothy Hale",   age: 84, sex: "F", diagnosis: "Hip fracture post-op", stay: "Day 4",     fallRisk: true,  wanderer: false, transfer: "mechanical-lift", continence: "incontinent", updatedMinAgo: 8,  tasksDone: 1, tasksTotal: 6 },
  ...
  { id: 3,  room: "107A", name: "Margaret Cho",   age: 88, sex: "F", diagnosis: "Dementia",             stay: "long-term", fallRisk: true,  wanderer: true,  transfer: "two-person",      continence: "incontinent", timeSensitive: { label: "Dressed", due: "09:00" }, preferences: ["Female care staff only"], updatedMinAgo: 60, tasksDone: 0, tasksTotal: 4 },
  ...
  { id: 5,  room: "112B", name: "Rosa Marin",     age: 90, sex: "F", diagnosis: "CHF",                  stay: "monitored", fallRisk: true,  wanderer: false, transfer: "one-assist",      continence: "continent",   timeSensitive: { label: "Cardiology appt", due: "14:00" }, updatedMinAgo: 30, tasksDone: 4, tasksTotal: 6 },
  { id: 6,  room: "115A", name: "Henry Talbot",   age: 81, sex: "M", diagnosis: "Post-stroke rehab",    stay: "",          fallRisk: false, wanderer: false, transfer: "one-assist",      continence: "continent",   timeSensitive: { label: "PT eval", due: "11:00" }, updatedMinAgo: 9, tasksDone: 5, tasksTotal: 6 },
  ...
  { id: 8,  room: "120B", name: "Sam Greene",     age: 85, sex: "M", diagnosis: "Hospice comfort",      stay: "",          fallRisk: false, wanderer: false, transfer: "one-assist",      continence: "incontinent", updatedMinAgo: 5, tasksDone: 6, tasksTotal: 6 },
